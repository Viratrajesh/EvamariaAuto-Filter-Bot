...
BOT_TOKEN = environ.get('BOT_TOKEN', '8040135776:AAFImp2XhJC0ES6RkZverh6clpqCHOT_nAQ')
...
REQ_CHANNEL = environ.get('REQ_CHANNEL', '-1002712614937')
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002712614937')
